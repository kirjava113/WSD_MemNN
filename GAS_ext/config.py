...
class MemNNConfig(object):
    ...
    def __init__(self):
        ...
        self.gloss_expand_type = 4  # 0=None 1=hyper，2=hypo 3=hyper+hypo 4：hierarchical
        self.max_gloss_words = 100
        self.n_hyper = 3  # depth for hyper
        self.n_hypo = 3  # depth for hypo
        self.max_n_sense = 10
        self.min_sense_freq = 3  # too small freq will make training unstable

        # parameters for model
        self.n_lstm_units = 512
        self.gloss_emb_size = 256
    ...
    def random_config(self):
        ...
        self.batch_norm = random.choice([False, True])
